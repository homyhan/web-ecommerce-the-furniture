        ...
        <div class="row justify-content-between">
            <div class="col-lg-5">
                <div class="intro-excerpt">
                    <h1>Thiết kế <span clsas="d-block">Hiện đại & Sang trọng</span></h1>
                    <p class="mb-4">Khám phá thế giới của nội thất độc đáo và tạo nên không gian sống theo phong cách của bạn</p>
